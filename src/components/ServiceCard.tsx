...
export const ServiceCard = ({ icon, title, description }: IServiceCard) => {
  return (
    <motion.div
      ...
      className="min-w-[15rem] max-w-[24rem] min-h-[30rem] py-10 px-6 flex gap-10 flex-col justify-center items-center bg-gradient-to-r border-2 border-gray-300 from-gray-200 to-gray-300 rounded-lg"
    >
