...
export const AboutMeSection = () => {
  ...
  return (
    <motion.section
      ref={constraintsRef}
      className="relative min-h-fit py-24 px-10 flex flex-col justify-start items-start bg-zinc-900 overflow-hidden"
    >
      ...
      <div className="absolute w-full h-full flex justify-center align-center top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] max-md:hidden">
        <strong className="text-gray-600 opacity-20 text-8xl text-center cursor-default selection:bg-transparent">
          ARRASTE AS SETAS
        </strong>
      </div>
    </motion.section>
